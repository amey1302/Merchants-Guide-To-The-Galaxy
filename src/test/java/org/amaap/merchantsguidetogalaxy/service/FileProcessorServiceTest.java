...
import org.amaap.merchantsguidetogalaxy.controller.FileProcessorController;
...
class FileProcessorServiceTest {
    ...
    void shouldBeAbleToReadAndParseFile() throws IllegalPathExtensionException, IOException {
        ...
        // act
        Map<String,String> translationMap = fileProcessorService.readFileAndParse(filePath);
